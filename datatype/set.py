...
print("list -> set :", set([1,2,3,4,56]) )
print("tuple -> set :", set((1,2,3,4,5,65)))
print("dict -> set :", set({"no":1,"name":"honh","age":24})) # 키만 담긴다 
...
print("set -> list :", list(set3),type(list(set2)))
...
# %% update() : 여러개 요소 추가
s3.update([1,2,3,4,5,6,7,7,5,6,15])
print(s3)
