...
print("a 타입 : ", type(str(a)))
print("1.2타입 : ",type(str(1.2)))
print("True 타입 : ",type(str(True)),str(True))
print()
print("True 타입 : ",type(str(True)),int(True))
...
#print("'99.5'타입 :", type(int("99.5")), int("99.5"))
...
print("0 타입 :", type(bool(0.1)), bool(0.1))
print("0 타입 :", type(bool(0)), bool(0))
